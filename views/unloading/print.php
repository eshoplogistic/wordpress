...
<div class="esl-print" data-service="<?php echo esc_attr( $wc_esl_deliveryName ); ?>">
	...
	<div class="esl-print__buttons">
		<?php foreach ( $wc_esl_printButtons as $wc_esl_button ) : ?>
			<button type="button" class="button esl-print-button" data-mode="<?php echo esc_attr( $wc_esl_button['mode'] ); ?>"<?php if ( ! empty( $wc_esl_button['type'] ) ) : ?> data-type="<?php echo esc_attr( $wc_esl_button['type'] ); ?>"<?php endif; ?>>
