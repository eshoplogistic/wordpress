...
<input type="hidden" name="wc-esl-terminals" id="wcEslTerminals" value="<?php echo esc_attr($wc_esl_terminals) ?>" />
<input type="hidden" name="wc-esl-api-key-ya" id="wcEslKeyYa" value="<?php echo esc_attr($wc_esl_key_ya) ?>" />